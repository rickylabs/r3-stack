import {SyntheticEvent, forwardRef, useReducer} from 'react';
...
const Image = forwardRef<HTMLSpanElement, ImageProps>(
    (
        ...
        const [isLoading, stopLoading] = useReducer((_: any, ev: SyntheticEvent<HTMLDivElement, Event>) => (onLoad?.(ev), false), true)
